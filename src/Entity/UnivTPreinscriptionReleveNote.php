...
#[ORM\Entity(repositoryClass: \App\Repository\UnivTPreinscriptionReleveNoteRepository::class)]
class UnivTPreinscriptionReleveNote {
    ...
    #[ORM\JoinColumn(referencedColumnName: 'id')]
    #[ORM\ManyToOne(targetEntity: \UnivTEtudiant::class, inversedBy: 'releves')]
    private $etudiant;
