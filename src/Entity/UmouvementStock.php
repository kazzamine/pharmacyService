...
#[ORM\Entity(repositoryClass: \App\Repository\UmouvementStockRepository::class)]
#[ORM\HasLifecycleCallbacks]
class UmouvementStock
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: \App\Entity\Uarticle::class, inversedBy: 'umouvementStocks')]
    private $article;



    #[ORM\ManyToOne(targetEntity: \App\Entity\Udepot::class, inversedBy: 'umouvementStocks')]
    private $depot;
