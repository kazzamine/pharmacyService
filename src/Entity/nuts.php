...
class nuts {
    ...
    private $units =
        array(
          "USD" => array(
            100,
            "fr-FR" => array('dollar', 'dollars', 'centime', 'cents', '', ''),
          ...
          "MAD" => array(
            100,
            "fr-FR" => array('Dirham', 'Dirhams', 'centime', 'centimes', '', ''),
            "pt-PT" => array('euro', 'euros', 'cêntimo', 'cêntimos', 'm', 'm'),
            "en-EN" => array('euro', 'euros', 'cent', 'cents', '', '')
          ),
          "TND" => array(
            100,
            "fr-FR" => array('Tunisian Dinar', 'Tunisian Dinars', 'centime', 'centimes', '', ''),
            "pt-PT" => array('Tunisian Dinar', 'Tunisian Dinars', 'cêntimo', 'cêntimos', 'm', 'm'),
            "en-EN" => array('Tunisian Dinar', 'Tunisian Dinars', 'cent', 'cents', '', '')
          ),
          "Francs CFA" => array(
            100,
            "fr-FR" => array('Franc CFA', 'Francs CFA', 'centime', 'centimes', '', ''),
            "pt-PT" => array('Franc CFA', 'Francs CFA', 'cêntimo', 'cêntimos', 'm', 'm'),
            "en-EN" => array('Franc CFA', 'Francs CFA', 'cent', 'cents', '', '')
          ),
          "t"  => array(
            1000,
          ...
          "GNF" => array(
            1000,
            "fr-FR" => array('GNF', 'GNF', 'centime', 'centimes', '', ''),
            "pt-PT" => array('GNF', 'GNF', 'centime', 'centimes', 'm', 'm'),
            "en-EN" => array('GNF', 'GNF', 'cent', 'cents', '', '')
        ),
        "CHF" => array(
            1000,
            "fr-FR" => array('FRANC SUISSE', 'FRANCS SUISSE', 'centime', 'centimes', '', ''),
            "pt-PT" => array('FRANC SUISSE', 'FRANCS SUISSE', 'cêntimo', 'cêntimos', 'm', 'm'),
            "en-EN" => array('FRANC SUISSE', 'FRANCS SUISSE', 'cent', 'cents', '', '')
        ),
        "CAD" => array(
            1000,
            "fr-FR" => array('DOLLAR CANADIEN', 'DOLLARS CANADIENS', 'centime', 'centimes', '', ''),
            "pt-PT" => array('DÓLAR CANADENSE', 'DÓLARES CANADENSES', 'cêntimo', 'cêntimos', 'm', 'm'),
            "en-EN" => array('CANADIAN DOLLAR', 'CANADIAN DOLLARS', 'cent', 'cents', '', '')
        )
