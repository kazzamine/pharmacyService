...
#[ORM\Entity(repositoryClass: \App\Repository\TypeMarcheRepository::class)]
class TypeMarche
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(targetEntity: \App\Entity\PMarche::class, mappedBy: 'typeMarche')]
    private $pMarches;
    ...
    public function removePMarch(PMarche $pMarch): self
    {
        if ($this->pMarches->contains($pMarch)) {
            ...
            if ($pMarch->getTypeMarche() === $this) {
                $pMarch->setTypeMarche(null);
            }
        }
