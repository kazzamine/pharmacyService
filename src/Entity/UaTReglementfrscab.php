 ...
 * UaTReglementfrscab
 */
#[ORM\Table(name: 'ua_t_reglementfrs')]
#[ORM\Entity]
#[ORM\HasLifecycleCallbacks]
class UaTReglementfrscab
{
     ...
     * @var string
     */
    #[ORM\Column(name: 'type', type: 'string', length: 4, nullable: true, options: ['default' => 'FAF'])]
    private $type = 'FAF';

    /**
     * @var string|null
     */
    #[ORM\Column(name: 'id_client', type: 'string', length: 100, nullable: true)]
    private $idClient;
     ...
     */
    #[Assert\NotBlank]
    #[ORM\Column(name: 'datereglement', type: 'date', nullable: false)]
     ...
     */
    #[Assert\NotBlank]
    #[ORM\Column(name: 'mtreglement', type: 'float', precision: 10, scale: 0, nullable: false)]
    private $mtreglement;

    /**
     * @var int
     */
    #[ORM\Column(name: 'sens', type: 'smallint', nullable: false, options: ['default' => '-1'])]
    private $sens = '-1';
    ...
    #[ORM\ManyToOne(targetEntity: \App\Entity\UaTFacturefrscab::class, inversedBy: 'tReglementfrs')]
    ...
    private $compte;
       ...
       #[ORM\ManyToOne(targetEntity: \App\Entity\TrTransaction::class, inversedBy: 'uareglements')]
    private $transaction;
